...
% por algum motivo isso falha apos a ultima solucao
% e talvez seja a fonte de resultados repetidos
permutacao([],[]).
permutacao(L1, [E | L3]) :-
	select(E, L1, L2),
	permutacao(L2, L3).
...
solucionar(
	...
	% o que consegui otimizar pertence a esse bloco
	...
	% a seguir estao as regras que nao consegui otimizar
	% ou que ficariam muito dificeis de ler
	...
	!. % o prolog estava tanto o mesmo resultado varias vezes
...
main(Args) :-
	...
	solucionar(A, B, C, D, E),
	escrever_solucao([A, B, C, D, E]).